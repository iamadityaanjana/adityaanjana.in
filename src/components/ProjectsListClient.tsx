...
export default function ProjectsListClient({ projects }: ProjectsListClientProps) {
  ...
  return (
    <div className="min-h-screen">
      <OnekoCat />
      <div className="flex flex-col items-start px-6 md:px-12 pt-4 md:pt-6 space-y-8 md:space-y-12 max-w-4xl mx-auto">
        ...
        <div className="w-full">
          <div className="mb-10">
            <BackButton />
            <h1 className="text-3xl md:text-4xl font-medium mb-4 mt-6">Projects</h1>
